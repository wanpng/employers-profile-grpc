...
type EmployerGrpc struct {
	...
	IsLanceo           bool   `protobuf:"varint,9,opt,name=is_lanceo,json=isLanceo,proto3" json:"is_lanceo,omitempty"`
}
...
func (x *EmployerGrpc) GetIsLanceo() bool {
	if x != nil {
		return x.IsLanceo
	}
	return false
...
var file_protos_domain_employer_grpc_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x22, 0xc4, 0x02, 0x0a, 0x0c, 0x45, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x72, 0x47,
	...
	0x79, 0x49, 0x6e, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x09,
	0x69, 0x73, 0x5f, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x6f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x08, 0x69, 0x73, 0x4c, 0x61, 0x6e, 0x63, 0x65, 0x6f, 0x42, 0x36, 0x5a, 0x34, 0x67, 0x69, 0x74,
