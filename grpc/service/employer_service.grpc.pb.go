...
var file_protos_service_employer_service_grpc_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x6f, 0x79, 0x65, 0x72, 0x32, 0x69, 0x0a, 0x0f, 0x45, 0x6d, 0x70, 0x6c, 0x6f, 0x79,
...
var file_protos_service_employer_service_grpc_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_protos_service_employer_service_grpc_proto_goTypes = []interface{}{
	...
	(*domain.EmployerGrpc)(nil), // 2: protos.domain.EmployerGrpc
}
var file_protos_service_employer_service_grpc_proto_depIdxs = []int32{
	2, // 0: protos.service.GetEmployerResponse.employer:type_name -> protos.domain.EmployerGrpc
	0, // 1: protos.service.EmployerService.GetEmployer:input_type -> protos.service.GetEmployerRequest
	1, // 2: protos.service.EmployerService.GetEmployer:output_type -> protos.service.GetEmployerResponse
